                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" action="{{url('/update-post',$edit_post->post_id)}}" method="post" enctype="multipart/form-data">
                                    	...
                                    	{{csrf_field()}}
                                    	  ...
                                    	  <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="author_name" value="{{$edit_post->author_name}}" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="post_title" value="{{$edit_post->post_title}}" required="">
                                    ...
                                    <div class="form-group">
                                            <label>Selects</label>
                                            <select class="form-control" name="category_id" value="{{$edit_post->category_name}}">
                                                 <?php 
                            ...
                            {{$edit_post->post_image}}
                            </div> 


                                <div class="form-group">
                                            <label>Post Body</label>
                                            <textarea class="form-control" rows="3" name="post_body"> {{$edit_post->post_body}}</textarea>
